...
export default function Portfolio() {
    ...
    return (
        <Container
            fluid="xl"
            className="portfolio d-flex flex-column justify-content-center align-items-center py-5 mt-5"
            id="portfolio"
        >
            <h1>PORTFOLIO</h1>
            <ul className="d-flex">
            ...
            <div className="project-container d-flex flex-wrap justify-content-center justify-content-md-between align-items-center px-3">
                {data.map((d, index) => (
                    <div
                        className="item shadow d-flex justify-content-center align-items-center mb-3"
                        key={index}
                    >
                        <img src={d.img} alt="" />
                        <Button
