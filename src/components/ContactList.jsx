    ...
    <div className="contact">
      <ul className="contact__list">
        <li className="contact__item">
          <a
            href="https://www.linkedin.com/in/lisa-li-23568b1b8/"
            target="_blank"
            rel="noreferrer"
        ...
        <li className="contact__item">
          <a
            href="https://github.com/2016lisali"
            target="_blank"
            rel="noreferrer"
        ...
        <li className="contact__item">
          <a
            href="mailto:lisa20210219@gmail.com"
            target="_blank"
            rel="noreferrer"
        ...
        <li className="contact__item">
          <a
            href="https://drive.google.com/file/d/1DsH3VyUYkBhNs-TAYXIgK0ZCdWg9bo1W/view"
            target="_blank"
            rel="noreferrer"
