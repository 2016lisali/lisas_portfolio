...
(function () {
    ...
    function S(e, b, c) {
        var a = k(b, c),
            d;
        return a
            ? ((d = a.getContext("2d")), d.drawImage(e, 0, 0, b, c), a)
            : null;
    }
        ...
        return (
            ...
            !e
                ...
                : ((d = e.getContext("2d")),
                  ...
                  a && (d.shadowBlur = a * b),
                  c &&
                      ((d.shadowOffsetX = c[0] * b),
                      (d.shadowOffsetY = c[1] * b)),
            ...
            b.txtOpt &&
                ...
                parseFloat(b.imageRadius) &&
                    (a.image =
                        a.fimage =
                        g =
                            at(a.image, b.imageRadius, f, d, h)),
                a.HasText() ||
                    (b.shadow &&
                        ((c = ao(
                            a.image,
    ...
    function ad(e) {
        ...
        for (g in c.tc)
            (b = c.tc[g]),
                b.tttimer && (clearTimeout(b.tttimer), (b.tttimer = null));
        f &&
            c.tc[f] &&
            ((b = c.tc[f]),
    ...
    function aq(b) {
        ...
        e &&
            ...
            ((d = f.tc[e]),
            ad(b),
            !d.EndDrag() && !d.touchState && d.Clicked(b));
    }
    function ar(c) {
        var e = u(c),
            b = e && a.tc[e],
        ...
        (F.Lines = function (c) {
            ...
            for (a = 0; a < d; ++a)
                b[a].nodeName == "BR"
                    ...
                    : this.Lines(b[a]);
            return (
                e || this.br || this.text.push(this.line.join(" ")), this.text
            );
        }),
    ...
    function _(a, b) {
        (this.ts = null),
            ...
            this.colour == "tag"
                ...
                : this.colour == "tagbg" &&
                  (this.colour = i(b.a, "background-color")),
        ...
        (f.DrawSize = function (i, n, m, l, k, j, a, h, g) {
            ...
            return (
                this.pulsate
                    ? (a.image
                          ? (d =
                                (a.image.height + this.tc.outlineIncrease) /
                                a.image.height)
                          : (d = a.oscale),
                      (b = a.fimage || a.image),
        ...
        (f.DrawPulsate = function (h, d, e, f) {
            var g = q() - this.ts,
                ...
                b =
                    ...
                    (1 - c.pulsateTo) *
                        (0.5 +
                            l((2 * Math.PI * g) / (1e3 * c.pulsateTime)) / 2);
            return (
                (this.pulse = b = a.Smooth(1, b)),
                this.DrawSimple(h, d, e, f, b, 1)
            );
        }),
    ...
    function a(f, o, k) {
        ...
        if (
            ...
            (j[f] = [
                ...
                this.dragControl &&
                    (j[f].push(["mousedown", ap]),
                    j[f].push(["selectstart", x])),
                this.wheelZoom &&
                    (j[f].push(["mousewheel", ab]),
                    j[f].push(["DOMMouseScroll", ab])),
    ...
    (b = a.prototype),
        ...
        (b.CreateTag = function (b) {
            ...
            if ("text" != this.imageMode)
                if (((e = b.getElementsByTagName("img")), e.length))
                    if (
                        ((c = new Image()), (c.src = e[0].src), !this.imageMode)
                    )
                        return (
        ...
        (b.Update = function () {
            ...
            if (e.length) {
                ...
                for (a = 0; a < g; ++a) {
                    for (b = 0, k = 0; b < i; ++b)
                        j[b].EqualTo(e[a]) &&
                            (this.UpdateTag(d[b], e[a]), (k = c[b] = -1));
                    k || f.push(a);
                }
                for (a = 0, b = 0; a < i; ++a)
        ...
        (b.Draw = function (s) {
            ...
            else if (((this.active = null), this.CheckAudioIcon()))
                m = "pointer";
            else {
                for (c = 0; c < k; ++c)
                    (f =
            ...
            for (c = 0; c < k; ++c) {
                ...
                (b && b.tag == e[c] && b.PreDraw(d, e[c], h, g)) ||
                    e[c].Draw(d, h, g),
